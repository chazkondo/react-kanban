      ...
      <div className="App">
        ...
        <header className="App-header">
          <h1
            id="Home"
            onClick={console.log(
              "Hi, check out my website: https://chazkondo.com - thanks for visiting :)"
            )}
          ...
          <div>
            <p className="title-right" onClick={this.show.bind(this)}>
              <span id="AddItem">+</span>
              <span id="enlarge">+</span> NEW TASK
            </p>
            <span
              className="title-right-minus"
              onClick={() => {
                for (let i = 1; i < this.props.items.items.length + 1; i++) {
                  ToggleOff(i);
                }
              }}
            >
            ...
            <Rodal
              animation="door"
              duration="800"
              visible={this.props.items.visible}
              onClose={this.hide.bind(this)}
            >
              <div className="shortDiv">
                <ItemForm
                  triggerClose={this.hide.bind(this)}
        ...
        <div className="demo-banner">
          👓 Kanban Demo | Features work locally | Built with Docker, React,
          React DnD, PostgreSQL
        </div>
...
class Todo extends Component {
  ...
  render() {
    return this.props.props.items.items
          ...
          <Draggable key={item.id} draggableId={item.id} index={index}>
            {(provided, snapshot) => (
              ...
              >
                <span
                  className="expand"
                  onClick={() => GetDescription(item.sortingid)}
                >
                  [ Expand ]
                </span>
                ...
                <span
                  onClick={() =>
                    this.props.deleteItemById(item, this.props.items.items)
                  }
                  className="x"
                >
                  x
                ...
                <ItemEdit
                  currentCache={this.props.props.items.items}
                  item={item}
                />
              </div>
            )}
